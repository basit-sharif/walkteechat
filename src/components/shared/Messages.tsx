...
const Messages = ({ initialMessages, sessionId, sessionImg, chatPartner }: { initialMessages: message[], sessionId: string, sessionImg: string | undefined | null, chatPartner: user }) => {
